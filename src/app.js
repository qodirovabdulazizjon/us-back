...
app.use(cors({
  origin: 'https://userbot-front-git-main-qodirovabdulazizjongmailcoms-projects.vercel.app/', // Telegram Mini App va barcha manbalardan keladigan so'rovlarga ruxsat beradi
